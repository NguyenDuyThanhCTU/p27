      ...
      <div className="p-4 font-normal text-gray-700">
        <div className="flex justify-between">
          <div className="flex items-center gap-5">
            <div>
              <h3 className="text-[30px] font-bold">Dòng xe</h3>
              <p className="font-light">Danh sách Dòng xe</p>
            </div>
            <div>
              <CRUDButton
          ...
          <div className="flex items-center gap-4 text-[14px] ">
            <div className="flex items-center gap-1">
              <PiCardsLight />
              <p>{Data?.length} Dòng xe</p>
            </div>
          </div>
        </div>
        <div className="mt-5 text-black">
          <div className="grid grid-cols-8 border-b-2 border-black py-3">
            {["STT", "Tên Dòng xe", "Logo", "Liên Kết", "Thời gian"].map(
              (item, idx) => (
                <div
                  key={idx}
                  className={`${
                    item === "Tên Dòng xe" || item === "Liên Kết"
