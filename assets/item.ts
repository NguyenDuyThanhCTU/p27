...
export const ProductTypeItems: any = [
  {
    label: "Cửa cổng",
    value: "cua-cong",
  },
  ...
  {
    label: "Mái hiên, giếng trời, nhà xe",
    value: "mai-hien-gieng-troi-nha-xe",
  },
  {
    label: "Xích đu, lò nướng",
    value: "xich-du-lo-nuong",
  },
  {
    label: "Bàn ghế",
    value: "ban-ghe",
  ...
  {
    label: "Đèn cổng, trang trí",
    value: "den-cong-trang-tri",
  },
];
